        ...
        <div className="bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block w-64">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 items-center">
                    <input type="number" min="0" max="50000" value={priceRange[0]} onChange={handleMinChange} className="w-20 p-1 border border-gray-300 rounded" />
                    <span>-</span>
                ...
                <input type="range" min="0" max="50000" step="1000" className="w-full" value={priceRange[0]} onChange={handleMinChange}/>
                <input type="range" min="0" max="999999" step="1000" className="w-full" value={priceRange[1]} onChange={handleMaxChange}/>
            </div>
            {/* Reset button */}
