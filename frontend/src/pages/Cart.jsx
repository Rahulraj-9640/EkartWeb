...
const Cart = () => {
  ...
  const API = `${import.meta.env.VITE_URL || 'http://localhost:8000'}/api/v1/cart`
    ...
    <div className="pt-20 bg-gray-50 min-h-screen">
      {
        cart?.items?.length > 0 ?
          <div className="max-w-7xl mx-auto">
          ...
          </div> : <div className="flex flex-col items-center justify-center min-h-[600vh] p-6 text-center">
            {/* Icon */}
            ...
            <p className="mt-2 text-gray-600">Looks li ke you haven't added anything to your cart yet</p>
