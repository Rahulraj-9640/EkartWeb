...
import { useParams, useParams as userParams } from "react-router-dom"
import {
    Card,
    CardContent,
    CardDescription,
...
const Profile = () => {
    ...
    return (
        <div className="pt-20 min-h-screen bg-gray-100">
            <Tabs defaultValue="profile" className='max-w-3xl mx-auto items-center'>
                <TabsList>
                        ...
                        <div className="flex flex-col justify-center items-center bg-gray-100">
                            ...
                            <div className="w-full flex gap-10 justify-between items-start px-7 max-w-2xl">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 shadow-lg p-5 rounded-lg bg-white">
                                    ...
                                    {loader? <><Loader2 className='h-4 w-4 animate-spin mr-2'/>Please wait</>:'update profile'}
